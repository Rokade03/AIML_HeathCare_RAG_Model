...
def get_conversational_chain():
    prompt_template = """ After getting the PDF you will identify if the pdf is related to medical field if not then give the prompt "The PDF is not a medical document" and don't give any reply else you are a professional medical agent who will analyze the report line by line and answer the question provied by the user in a detailed manner from the provided report, Make sure to provide all the details and readings, if the answer or information is not available in the context provided just return the statement, "Answer is not available in the context", Make sure you do not provide the wrong or incorrect answers to the user
     Context:\n {context}?\n
     Question:\n {question}\n 
...
def main():
    ...
    st.text("Note:Please Upload the report in the form of PDF")
